...
//        context = context.getApplicationContext();
            ...
            mAudioServiceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ...
                    try {
                        ...
                        Logg.e(TAG, "remote procedure call failed: addAudioCallback()");
                        if (connectionListerner != null)
    ...
    public void unbindAudioService(Context context) {
        if (context == null) {
            Logg.w(TAG, "unbindAudioService() with null Context. Ooops" );
            return;
        }
        context = context.getApplicationContext();
        ...
        if (mIsBound) {
            ...
            try {
                ...
                Logg.e(TAG, "remote procedure call failed: removeAudioCallback()");
            }
    ...
    private <T> T remoteProcedureCall(IAudioService instance, Class<T> returnType, T defaultValue, String functionName, Class<?> parameterTypes[], Object parameters[]) {
        ...
        try {
            ...
            if(e.getTargetException() instanceof RemoteException) {
                Logg.e(TAG, "remote procedure call failed: " + functionName + "()");
            }
            return defaultValue;
        }
    }
